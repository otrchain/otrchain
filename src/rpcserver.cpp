...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop OTRchain server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "OTRchain server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* OTRchain features */
        {"OTRchain", "masternode", &masternode, true, true, false},
        {"OTRchain", "listmasternodes", &listmasternodes, true, true, false},
        {"OTRchain", "getmasternodecount", &getmasternodecount, true, true, false},
        {"OTRchain", "masternodeconnect", &masternodeconnect, true, true, false},
        {"OTRchain", "masternodecurrent", &masternodecurrent, true, true, false},
        {"OTRchain", "masternodedebug", &masternodedebug, true, true, false},
        {"OTRchain", "startmasternode", &startmasternode, true, true, false},
        {"OTRchain", "createmasternodekey", &createmasternodekey, true, true, false},
        {"OTRchain", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"OTRchain", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"OTRchain", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"OTRchain", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"OTRchain", "getmasternodescores", &getmasternodescores, true, true, false},
        {"OTRchain", "mnbudget", &mnbudget, true, true, false},
        {"OTRchain", "preparebudget", &preparebudget, true, true, false},
        {"OTRchain", "submitbudget", &submitbudget, true, true, false},
        {"OTRchain", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"OTRchain", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"OTRchain", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"OTRchain", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"OTRchain", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"OTRchain", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"OTRchain", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"OTRchain", "checkbudgets", &checkbudgets, true, true, false},
        {"OTRchain", "mnsync", &mnsync, true, true, false},
        {"OTRchain", "spork", &spork, true, true, false},
        {"OTRchain", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"OTRchain", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use OTRchaind, or the -server option to OTRchain-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> OTRchain-cli " + methodname + " " + args + "\n";
}
