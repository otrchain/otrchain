/* src/config/OTRchain-config.h.  Generated from OTRchain-config.h.in by configure.  */
/* src/config/OTRchain-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef OTRchain_CONFIG_H

#define OTRchain_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.otrchain.com"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OTRchain"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OTRchain 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "OTRchain"
