...
enum RPCErrorCode {
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED = -9,        //! OTRchain is not connected
    ...
    RPC_WALLET_PASSOTRASE_INCORRECT = -14, //! The wallet passphrase entered was incorrect
