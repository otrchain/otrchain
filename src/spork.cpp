...
// OTRchain: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // OTRchain: add to spork database.
...
bool CSporkManager::CheckSignature(CSporkMessage& spork)
{
    ...
    string strSporkKey = "0236e7b6522c0dffe1530a35ff6439f17ef578289f41e031fb484d8bc327e18f70";
