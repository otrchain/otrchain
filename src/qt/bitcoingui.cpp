                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("OTRchain") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a OTRchain address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and OTRchain: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zOTR"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About OTRchain"), this);
    aboutAction->setStatusTip(tr("Show information about OTRchain"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for OTRchain"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your OTRchain addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified OTRchain addresses"));
    ...
    openAction->setStatusTip(tr("Open a OTRchain: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the OTRchain help message to get a list with possible OTRchain command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("OTRchain client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to OTRchain network", "", count));
}
...
{
    QString strTitle = tr("OTRchain"); // default title
