                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received OTRchain from zOTRchain"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zOTRchain"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zOTRchain));
