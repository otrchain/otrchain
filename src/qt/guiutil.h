...
/** Utility functions used by the OTRchain Qt UI.
 */
namespace GUIUtil
{
...
// Render OTRchain addresses in monospace font
...
// Parse "OTRchain:" URI into recipient object, return true on successful parsing
