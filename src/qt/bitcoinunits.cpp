...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(OTRchain);
    unitlist.append(mOTR);
    unitlist.append(uOTR);
    return unitlist;
}
...
QString BitcoinUnits::name(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case OTRchain:
            return QString("tOTR");
        case mOTR:
            return QString("mtOTR");
        case uOTR:
            return QString::fromUtf8("μtOTR");
        default:
            return QString("???");
        }
    }
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        switch (unit) {
        case OTRchain:
            return QString("OTRchain");
        case mOTR:
            return QString("Milli-OTRchain (1 / 1" THIN_SP_UTF8 "000)");
        case uOTR:
            return QString("Micro-OTRchain (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case OTRchain:
            return QString("TestOTRs");
        case mOTR:
            return QString("Milli-TestOTR (1 / 1" THIN_SP_UTF8 "000)");
        case uOTR:
            return QString("Micro-TestOTR (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
