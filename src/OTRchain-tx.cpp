...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("OTRchain OTRchain-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  OTRchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded OTRchain transaction") + "\n" +
                               "  OTRchain-tx [options] -create [commands]   " + _("Create hex-encoded OTRchain transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded OTRchain transaction
