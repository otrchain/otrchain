...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:35566", "127.0.0.1", 35566));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:35566", "127.0.0.1", 35566));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:35566", "::ffff:127.0.0.1", 35566));
    BOOST_CHECK(TestSplitHost("[::]:35566", "::", 35566));
    BOOST_CHECK(TestSplitHost("::35566", "::35566", -1));
    BOOST_CHECK(TestSplitHost(":35566", "", 35566));
    BOOST_CHECK(TestSplitHost("[]:35566", "", 35566));
...
{
    CService addr;
    if (!LookupNumeric(src.c_str(), addr, 35567))
        return canon == "";
...
{
    BOOST_CHECK(TestParse("127.0.0.1", "127.0.0.1:35566"));
    BOOST_CHECK(TestParse("127.0.0.1:35566", "127.0.0.1:35566"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:35566"));
    BOOST_CHECK(TestParse("::", "[::]:35566"));
    BOOST_CHECK(TestParse("[::]:35566", "[::]:35566"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:35566"));
...
BOOST_AUTO_TEST_CASE(subnet_test)
{
    ...
    BOOST_CHECK(!CSubNet("1.2.0.0/24").Match(CNetAddr("1.2.3.4")));
