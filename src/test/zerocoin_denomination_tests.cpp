...
//translation from OTRchain quantity to zerocoin denomination
BOOST_AUTO_TEST_CASE(amount_to_denomination_test)
{
    ...
    CAmount amount1 = 3000 * COIN;
    BOOST_CHECK_MESSAGE(AmountToZerocoinDenomination(amount1) == ZQ_FIVE_THOUSAND, "For 3000*COIN denomination should be ZQ_ONE");
