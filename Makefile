...
pkgdatadir = $(datadir)/OTRchain
pkgincludedir = $(includedir)/OTRchain
pkglibdir = $(libdir)/OTRchain
pkglibexecdir = $(libexecdir)/OTRchain
...
CONFIG_HEADER = $(top_builddir)/src/config/OTRchain-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/OTRchain-config.h.in \
...
ACLOCAL = ${SHELL} /Users/akshaycm/Documents/compileOTRchain3/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /Users/akshaycm/Documents/compileOTRchain3/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /Users/akshaycm/Documents/compileOTRchain3/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /Users/akshaycm/Documents/compileOTRchain3/build-aux/missing automake-1.16
AWK = awk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = OTRchain-cli
BITCOIN_DAEMON_NAME = OTRchaind
BITCOIN_GUI_NAME = OTRchain-qt
BITCOIN_TX_NAME = OTRchain-tx
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /Users/akshaycm/Documents/compileOTRchain3/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = :
PACKAGE = OTRchain
PACKAGE_BUGREPORT = www.otrchain.com
PACKAGE_NAME = OTRchain
PACKAGE_STRING = OTRchain 2.0.0
PACKAGE_TARNAME = OTRchain
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /Users/akshaycm/Documents/compileOTRchain3
abs_srcdir = /Users/akshaycm/Documents/compileOTRchain3
abs_top_builddir = /Users/akshaycm/Documents/compileOTRchain3
abs_top_srcdir = /Users/akshaycm/Documents/compileOTRchain3
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/akshaycm/Documents/compileOTRchain3/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_OTRchain_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_OTRchain_coverage.info test_OTRchain.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/OTRchain-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/OTRchain-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/OTRchain-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/OTRchain-config.h
$(top_srcdir)/src/config/OTRchain-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/OTRchain-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/OTRchain-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
#$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/OTRchain-Qt
...
#$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/OTRchain-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_OTRchain.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_OTRchain -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_OTRchain_filtered.info: test_OTRchain.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_OTRchain_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_OTRchain_coverage.info: baseline_filtered_combined.info test_OTRchain_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_OTRchain_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_OTRchain_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_OTRchain_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_OTRchain.coverage/.dirstamp:  test_OTRchain_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_OTRchain.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_OTRchain.coverage/ total.coverage/ $(OSX_APP)
