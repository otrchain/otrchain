...
RESOURCES += src/qt/OTRchain.qrc src/qt/OTRchain_locale.qrc

TRANSLATIONS += src/qt/locale/OTRchain_bg.ts \
                src/qt/locale/OTRchain_de.ts \
                src/qt/locale/OTRchain_en.ts \
                src/qt/locale/OTRchain_es.ts \
                src/qt/locale/OTRchain_fi.ts \
                src/qt/locale/OTRchain_fr.ts \
                src/qt/locale/OTRchain_it.ts \
                src/qt/locale/OTRchain_ja.ts \
                src/qt/locale/OTRchain_pl.ts \
                src/qt/locale/OTRchain_pt.ts \
                src/qt/locale/OTRchain_ru.ts \
                src/qt/locale/OTRchain_sk.ts \
                src/qt/locale/OTRchain_sv.ts \
                src/qt/locale/OTRchain_vi.ts \
                src/qt/locale/OTRchain_zh_CN.ts \
                src/qt/locale/OTRchain_zh_TW.ts
