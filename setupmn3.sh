...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='OTRchain.conf'
CONFIGFOLDER='/root/.OTRchain'
COIN_DAEMON='OTRchaind'
COIN_CLI='OTRchain-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO=''
COIN_TGZ='https://github.com/otrchain/otrchain.git'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='OTRchain'
COIN_PORT=35566 #Updated Port
RPC_PORT=6783
...
function prepare_system() {
 cd ~
  wget https://gist.githubusercontent.com/hoserdude/9661c9cdc4b59cf5f001/raw/5972d4d838691c1a1f33fb274f97fa0b403d10bd/OTRchain.txt
  cat OTRchain.txt
echo "OTRchain MN installer Depends Starting"
