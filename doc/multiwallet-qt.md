...
In order to support loading of multiple wallets in OTRchain-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is OTRchain.cpp.
...
Changes to OTRchain.cpp
----------------------
OTRchain.cpp is the entry point into OTRchain-qt, and as such, will require some minor modifications to provide hooks for
