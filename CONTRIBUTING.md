Contributing to OTRchain
============================

The OTRchain project operates an open contributor model where anyone is
...
The following applies to code changes to the OTRchain project, and is not to be
confused with overall OTRchain Network Protocol consensus changes.

Whether a pull request is merged into OTRchain rests with the project merge
...
Patches that change OTRchain consensus rules are considerably more involved than
...
Where a patch set proposes to change the OTRchain consensus, it must have been
...
The project leader is the release manager for each OTRchain release.
